import { productCatalog, type ProductCategoryKey, type ProductItem } from '~/data/products/catalog';
import type { StoredCartState } from '~/composables/cart/cartState.helpers';
