				...
				>
					...
					<div class="account-points-ranking-card-body">
						...
						<div class="account-points-ranking-card-section">
							<h4 class="account-points-ranking-card-label">{{ translate('account.points.ranking.perksLabel') }}</h4>
						...
						<div class="account-points-ranking-card-section">
							<h4 class="account-points-ranking-card-label">{{ translate('account.points.ranking.levelUpBonusLabel') }}</h4>
							<ul class="account-points-ranking-card-list">
...
.account-points-ranking-modal {
	...
	.account-points-ranking-card {
		...
		&[data-current='true'] {
			border-color: #ff41cb;
			box-shadow: 0 12px 28px rgba(255, 65, 203, 0.14);
		}
	}
