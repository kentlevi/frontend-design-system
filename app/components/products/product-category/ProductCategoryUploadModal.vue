            ...
            <div v-if="props.open" class="upload-modal-overlay" @click.self="emit('close')" data-testid="product-category-upload-overlay">
                <section class="upload-modal" role="dialog" aria-modal="true" data-testid="product-category-upload-dialog">
                    <header class="upload-modal-header" data-testid="product-category-upload-header">
                        <h3 class="upload-modal-title" data-testid="product-category-upload-title">{{ t('checkout.upload.title') }}</h3>
                        <UiButton
                            type="button"
                            variant="ghost"
                            tone="neutral"
                            ...
                            @click="emit('close')"
                            data-testid="product-category-upload-close"
                        >
                    ...
                    <div class="upload-modal-body" data-testid="product-category-upload-body">
                                ...
                                <div class="upload-dropzone-copy" data-testid="product-category-upload-empty-state">
                                    ...
                                    <div>
                                        <p class="upload-dropzone-title">
                                            {{ t('checkout.upload.dragDropTitle') }}
                                        </p>
                                        <p class="upload-dropzone-meta">
                                            {{ t('checkout.upload.acceptedTypes') }}
                                        </p>
                                    </div>
                                </div>
                                <UiButton
                                    ...
                                    data-testid="product-category-upload-select-files"
                                >
                                    {{ t('checkout.upload.selectFiles') }}
                                </UiButton>
                            </template>
                            <template v-else>
                                ...
                                <div class="upload-file-actions" data-testid="product-category-upload-file-actions">
                                    <UiButton
                                        ...
                                        class="upload-secondary-btn"
                                        @click="emit('open-file-picker')"
                                        data-testid="product-category-upload-replace-image"
                                    >
                                        {{ t('checkout.upload.replaceImage') }}
                                    </UiButton>
                                    <UiButton
                                        type="button"
                                        variant="outline"
                                        ...
                                        data-testid="product-category-upload-remove-image"
                                    >
                        ...
                        <label class="upload-notes" data-testid="product-category-upload-notes">
                            <span>{{ t('checkout.upload.specialInstructions') }}</span>
                            <UiTextarea
                                class="upload-notes-textarea"
                                :model-value="props.specialInstructions"
                                rows="4"
                                resize="none"
                                :placeholder="t('checkout.upload.specialInstructionsPlaceholder')"
                    ...
                    <footer class="upload-modal-footer" data-testid="product-category-upload-footer">
                        <UiButton
                            ...
                            data-testid="product-category-upload-skip"
                        >
                            {{ t('checkout.upload.skipUploadLater') }}
                        </UiButton>
                        <UiButton
                            type="button"
                            variant="filled"
                            ...
                            data-testid="product-category-upload-proceed"
                        >
                            <UiIcon name="strong-shop-cart" :size="18" color="#ffffff" />
                            {{ t('checkout.upload.addToCart') }}
                        </UiButton>
                    </footer>
                </section>
            </div>
