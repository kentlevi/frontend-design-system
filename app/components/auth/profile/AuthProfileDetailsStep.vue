...
<template>
	<div
		class="auth-profile-details-step"
		data-testid="auth-profile-details-step"
	>
		<div
			class="auth-profile-details-main"
			data-testid="auth-profile-details-main"
		>
			<header
				class="auth-profile-head"
				data-testid="auth-profile-details-header"
			>
		...
		<div
			class="auth-profile-actions"
			data-testid="auth-profile-details-actions"
		>
			<UiButton
				v-if="can_skip_profile_details"
				variant="ghost"
				tone="neutral"
				size="md"
			...
			<UiButton
				...
				:disabled="!can_continue_profile_details"
				@click="goNext"
			>
