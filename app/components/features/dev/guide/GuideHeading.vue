		...
		<table class="guide-table">
			...
			<tbody>
				<tr>
					...
					<td><code>'2'</code></td>
					<td>Heading level (h1–h6).</td>
				</tr>
				<tr>
					<td>weight</td>
					<td><code>thin | extra-light | light | regular | medium | semi-bold | bold</code></td>
				...
				<tr>
					...
					<td><code>''</code></td>
					<td>Custom text color (CSS value or token).</td>
				</tr>
				<tr>
					<td>align</td>
					<td><code>left | right | center | inherit</code></td>
