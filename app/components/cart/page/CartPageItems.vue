	...
	<section class="cart-list" data-testid="cart-page-list">
		...
		>
			...
			<div class="cart-row-main">
				...
				<div class="cart-qty-wrap">
					...
					>
						<input
							...
							@blur="commitCustomQty(row.local_identity)"
							@keydown.enter.prevent="commitCustomQty(row.local_identity)"
						>
						<button
							type="button"
							...
							<div v-if="custom_qty_menu_open" class="ui-select-menu cart-qty-menu" role="listbox">
								<div class="ui-select-options">
									<button
										...
										@mousedown.prevent="handleQtyOptionSelect(row.local_identity, option.value)"
									>
				...
				<strong class="cart-row-price">{{ formatPrice(row.cost) }}</strong>
			</div>
