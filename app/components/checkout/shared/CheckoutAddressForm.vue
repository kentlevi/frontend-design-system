...
<template>
	<div class="checkout-member-address-form-content">
		...
		<div class="checkout-member-field-grid">
			...
			<UiFormField :label="t('checkout.guest.fields.province.label')" :required="true" :show-required-mark="true" head-class="checkout-form-field-head" label-class="checkout-form-field-label" label-text-class="checkout-form-field-label-text">
				<UiSelect v-model="province" :options="props.provinceOptions" :placeholder="t('checkout.guest.fields.province.placeholder')" class="checkout-member-select" trigger-class="checkout-member-select-trigger" />
			</UiFormField>
		</div>
		<div class="checkout-member-field-grid">
			...
			<UiFormField v-if="!props.hidePhone" :label="t('checkout.guest.fields.phone.label')" :required="true" :show-required-mark="true" head-class="checkout-form-field-head" label-class="checkout-form-field-label" label-text-class="checkout-form-field-label-text">
				<UiInput v-model="phone" :size="props.size" :placeholder="t('checkout.guest.fields.phone.placeholder')" />
			</UiFormField>
		</div>
	</div>
</template>
...
.checkout-member-address-form-content {
	display: flex;
